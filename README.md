...
### 2. How to Run
- Download the [![Linux bundle](https://img.shields.io/badge/Linux-v0.9.0-orange?style=flat-square&logo=linux)](https://github.com/Luiz-Alcantara/Neural-Pixel/releases/download/v0.9.0/NeuralPixel-Linux_v0.9.0.zip)
...
### 2. How to Run
- Download the [![Windows bundle](https://img.shields.io/badge/Windows-v0.9.0-blue?style=flat-square&logo=windows)](https://github.com/Luiz-Alcantara/Neural-Pixel/releases/download/v0.9.0/NeuralPixel-Windows_v0.9.0.zip)
