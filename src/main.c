...
app_activate (GApplication *app, gpointer user_data)
{
	...
	gtk_widget_add_css_class(paned, "custom_paned");
	...
	gtk_widget_set_size_request(preview_img2img, -1, 460);
	...
	gen_d->width_dd = width_dd;
	gen_d->height_dd = height_dd;
	gen_d->sampler_dd = sampler_dd;
	gen_d->scheduler_dd = scheduler_dd;
	gen_d->hires_upscaler_dd = hires_upscaler_dd;
	gen_d->vae_tiling_dd = vae_tiling_dd;
	gen_d->model_runtime_backend_dd = model_runtime_backend_dd;
	gen_d->model_parameter_backend_dd = model_parameter_backend_dd;
	gen_d->te_runtime_backend_dd = te_runtime_backend_dd;
	gen_d->te_parameter_backend_dd = te_parameter_backend_dd;
	gen_d->vae_runtime_backend_dd = vae_runtime_backend_dd;
	gen_d->vae_parameter_backend_dd = vae_parameter_backend_dd;
	gen_d->cnet_runtime_backend_dd = cnet_runtime_backend_dd;
	gen_d->cnet_parameter_backend_dd = cnet_parameter_backend_dd;
	gen_d->upscaler_runtime_backend_dd = upscaler_runtime_backend_dd;
	gen_d->upscaler_parameter_backend_dd = upscaler_parameter_backend_dd;
	gen_d->detector_runtime_backend_dd = detector_runtime_backend_dd;
	gen_d->detector_parameter_backend_dd = detector_parameter_backend_dd;
	...
	if (get_dd_item_count(GTK_DROP_DOWN(checkpoint_dd)) <= 1) {
		show_no_models_message(win);
	}
}
